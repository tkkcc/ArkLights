...
在一个脚本能连接的设备上（模拟器上脚本能连接的宿主机、安卓脚本能连接的同设备termux、安卓脚本能连接有公网IP的服务器），用npm安装[qqimagedeliver](https://github.com/tkkcc/qqimagedeliver)
```sh
...
将`服务器IP地址或域名:服务端口`填写脚本高级设置`QQ通知自建服务地址`
```txt
82.156.198.12:49875
```
