...
point = {
  ...
  信用交易所 = function()
    -- TODO add findOne("主页") work?
    return (findOne("信用交易所已购列表1") or
             findOne("信用交易所列表1")) and findOne("主页")
  end,
  ...
  信用交易所已购列表1 = "195,225,#ACACAC",
  信用交易所列表 = {
    "195,225,#313131", "575,225,#313131", "955,225,#313131", "1340,225,#313131",
    "1715,225,#313131", "195,605,#313131", "575,605,#313131", "955,605,#313131",
    "1340,605,#313131", "1715,605,#313131",
  },
