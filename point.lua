...
point = {
  ...
  作战列表 = {
    ...
    ["LS-1"] = "388|829|000000,774|798|000000,1099|699|000000,1359|570|000000,1527|408|000000",
...
distance = {
  ...
  ["HD-2"] = {swip_right_max, -650},
  ["HD-3"] = {swip_right_max, -950},
  ["HD-4"] = {swip_right_max, -1150},
  ["HD-5"] = {swip_right_max, -1650},
  ["HD-6"] = {swip_right_max, -1900},
  ["HD-7"] = {swip_right_max, -2050},
...
expand_fight = function()
  ...
  for i = 2, 5 do target['LS-' .. i] = rotate_point(target['LS-' .. (i - 1)]) end
  iter = {'CA', 'SK'}
  ...
  iter = {'CE'}
  for _, v in pairs(iter) do
    for i = 0, 5 do target[v .. '-' .. i] = target['LS-' .. i] end
  end
end
expand_fight()
