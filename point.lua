...
point = {
  -- 筛选横线 = "1246,23,#1E1E1E",
  -- 筛选横线 = "1795,1000,#FFFFFF",
  -- 筛选横线 = "559,20,#313131|558,19,#8F8F93",
  筛选横线 = "58,59,#FFFFFF",
  -- 赤金加速 = "676,846,#FFD802|643,846,#FDDA00|665,858,#141412|657,858,#1B1B1B|658,846,#1A1A15|660,837,#202000|664,851,#FBDA00",
  -- 赤金加速 = "677,423,#FFD802|654,408,#FFD802|669,409,#FED802|649,431,#FED802",
  赤金加速 = "677,423,#FFD802|654,408,#FFD802|669,409,#FED802|649,431,#FED802|676,404,#FDFDFD",
  经验站 = "99,884,#161616",
  赤金站 = "99,884,#7C5829",
  ...
  -- 缩放结束 = "943,363,#F1F0F1|1607,870,#F1F0F1|1623,917,#F1F0F1|896,235,#F1F0F1",
  -- 缩放结束 = "947,406,#F1F0F1|1449,792,#F1F0F1|50,595,#F1F0F1",
  -- 缩放结束 = "947,406,#F1F0F1|1863,799,#F1F0F1|50,595,#F1F0F1",
  -- 缩放结束 = "947,406,#F1F0F1|50,595,#F1F0F1|608,786,#F1F0F1",
  -- 缩放结束 = "50,595,#F1F0F1|947,409,#F1F0F1|906,361,#F1F0F1|833,386,#F1F0F1|910,889,#F1F0F1|881,855,#F1F0F1|952,789,#F1F0F1",
  -- 缩放结束 = "952,412,#F1F0F1|190,415,#F1F0F1|177,506,#F0F0F1|58,599,#F1F0F1|177,684,#F0EFEF|887,786,#F1F0F1|994,901,#F1F0F1",
  ...
  -- "947,406,#F1F0F1|608,786,#F1F0F1",
  --     {0,0,0,0,,95}
  -- 缩放结束 = "950,405,#F1F0F1|1449,789,#F1F0F1",
  -- {0,0,0,0,"950,405,#F1F0F1|1449,789,#F1F0F1",95}
  信赖采样列表 = {{1438, 64}},
  心情采样列表 = {{1559, 69}},
  ...
  信用交易所 = function()
    ...
    return true
    -- TODO add findOne("主页") work? no
    -- TODO first see the first 物品, then see the border of blue box
    -- return (findOne("信用交易所已购列表1") or
    --          findOne("信用交易所列表1")) and
    --          findOne("干员解锁进度")
  end,
  ...
  信用交易所已购列表 = {
    "195,222,#ACACAC", "575,222,#ACACAC", "955,222,#ACACAC", "1340,222,#ACACAC",
    "1715,222,#ACACAC", "195,603,#939393", "575,603,#939393", "955,603,#939393",
    "1340,603,#939393", "1715,603,#939393",
  },
  信用交易所列表 = {
    "195,222,#313131", "575,222,#313131", "955,222,#313131", "1340,222,#313131",
    "1715,222,#313131", "195,603,#313131", "575,603,#313131", "955,603,#313131",
    "1340,603,#313131", "1715,603,#313131",
  },
  ...
  基建副手列表 = {
    -- {600, 300}, {300, 800}, {500, 800}, {850, 800}, {1070, 800},
    -- {600, 300}, {300, 800}, {500, 800}, {850, 800}, {1070, 800},
    {536, 300}, {176, 900}, {418, 900}, {656, 900}, {897, 900},
    -- {772, 300}, {414, 800}, {653, 800}, {893, 800}, {1136, 800},
  },
  干员空隙列表 = {
    {851, 300}, {1064, 300}, {1285, 300}, {1499, 300}, {1722, 300}, {1933, 300},
    {2154, 300}, {2373, 300}, -- row 1
  },
  ...
  -- 任务第一个 = "703,17,#313131|1260,17,#E1E1E1",
  ...
  今日参与交流已达上限 = "1815,127,#FFFFFF|1844,131,#FFFFFF|1838,125,#040404|1848,126,#040404",

  右确认 = {1260, 743},
  左取消 = {671, 746},
  解锁线索 = "1018,950,#FFFFFF",
  线索库列表 = {{1645, 470}},
  -- 解锁线索上 = {179, 963},
  解锁线索上 = {1008, 900},
  线索布置按下列表 = {
  ...
  活动签到返回 = "1804,114,#BFBFBF|1873,119,#595959|1907,150,#595959|1876,182,#595959|1842,153,#595959",
  ...
  账号登录 = "508,728,#565656|743,800,#565656|1094,626,#211818|816,628,#211818",
  ...
  -- 干员选择列表 = {
  --   {630, 485}, {630, 905}, {851, 485}, {851, 905}, {1072, 485}, {1072, 905},
  --   {1292, 485}, {1292, 905}, {1494, 485}, {1494, 905}, {1712, 485},
  --   {1712, 905},
  -- },
  制造站收取 = {1700, 1000},
  ...
  接管作战 = "695,1002,#313131|703,999,#FFFFFF|711,995,#313131|709,979,#313131|719,977,#FFFFFF|731,977,#313131",
  -- 任务
  ...
  -- 返回确认2 = "926,486,#313131|1105,478,#313131|745,490,#313131|1139,479,#313131", -- what's this
...
update_assistant_position = function()
  local t = {}
  for i = 1, #point.基建副手列表 do
    local x, y
    x = point["基建副手列表" .. i][1]
    if x > 627 * minscale then
...
rfg = {
  ...
  入驻干员 = point.入驻干员范围,
  赤金加速 = {math.round(minscale * 600), 0, screen.width, screen.height},
}
-- log(type(minscale)) log(1309, minscale * 600, minscale, 600 * 1.0)
log(rfg)
