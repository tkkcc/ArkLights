...
[7时56分速刷999源石锭](https://www.bilibili.com/video/BV1FF411n7aU)

## 特点

1. 支持明日方舟官服与B服。
1. 支持真机、云手机、模拟器及虚拟机（安卓7至11，DPI>=320，分辨率>=720x1280，长宽比>=16:9）。
1. 支持多账号、定时任务、亮屏解锁、~~区分赤金经验加速技能~~、完成后通知QQ等。
1. 极低等待耗时，快过手操。全托管，高鲁棒。免root，热更新。
1. 支持集成战略刷投资，全结局满级幕后筹备条件下7时42分刷999源石锭，平均每小时129个。
1. 不统计掉落，不支持高产率基建换班，不支持无人机加速贸易站，不检测代理失误。

## 安装

下载[明日方舟速通](https://wwa.lanzoui.com/b010qimmf)（密码0000）

基建换班产率低于 明日再肝、MeoAssistantArknights等脚本  
不支持mumu安卓6、红手指安卓6。
