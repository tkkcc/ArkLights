...
function metat.__index:receiveheaders() return self.try(receiveheaders(self.c)) end
...
function metat.__index:receivebody(headers, sink, step)
  ...
  return self.try(ltn12.pump
                    .all(socket.source(mode, self.c, length), sink, step))
end
...
local function adjustheaders(reqt)
  ...
  if reqt.user and reqt.password then
    lower["authorization"] = "Basic " ..
                               (mime.b64(reqt.user .. ":" .. reqt.password))
  end
...
local function shouldredirect(reqt, code, headers)
  return headers.location and string.gsub(headers.location, "%s", "") ~= "" and
